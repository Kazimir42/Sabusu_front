...
function SubscriptionForm(props) {
    return (<form>
        ...
        <div className="flex flex-col gap-8">
            <div>
                ...
                <div className="grid grid-cols-4 gap-4">
                    {props.frequencies.map(frequency => (<BlockButton
                        ...
                        class={props.selectedFrequency === frequency ? "border-2 border-primary" : ""}>
                        <img
                    ...
                    <input hidden={true} required={true} defaultValue={props.selectedFrequency}/>
                </div>
            </div>
            <div className="grid grid-cols-2 gap-4 flex-grow">
                <div className="col-span-1 flex flex-col gap-4">
                    <div className="w-1/2">
                        <H3 class="mb-2 w-full">Title</H3>
                        <p className="text-gray-500 w-full">
                            I'm a little desc
                        </p>
                        <Input
                            class="p-3 bg-transparent border shadow-none w-full"
                            value={props.title}
                            required={true}
                    ...
                    <div className="w-1/2">
                        <H3 class="mb-2 w-full">Amount</H3>
                        <p className="text-gray-500 w-full">
                            I'm a little desc
                        </p>
                ...
                <div className="col-span-1 flex flex-col gap-4">
                    <div className="w-1/2">
                        <H3 class="mb-2 w-full">Subscription date</H3>
                        <p className="text-gray-500 w-full">
                            I'm a little desc
                        </p>
                        <Input
                    ...
                    <div className="w-1/2">
                        <H3 class="mb-2 w-full">Next payment date</H3>
                        <p className="text-gray-500 w-full">
                            I'm a little desc
                        </p>
                        <Input
            ...
            <Button class="w-fit py-4 px-8 text-lg" type={'submit'}>
                Create
            </Button>
        </div>
    </form>);
